/**
 * @fileoverview Card de métrica operacional com ícone, indicador de variação e Motion
 */
...
export function MetricCard({
  ...
  return (
    ...
    >
      <Card
        onClick={onClick}
        className={`h-full p-5 flex flex-col justify-between transition-colors shadow-xs hover:shadow-md ${style.border} ${
