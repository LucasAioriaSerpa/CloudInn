    ...
    >
      <div className="space-y-4">
        ...
        <div className="p-3 bg-amber-50 rounded-xl border border-amber-200 text-xs text-amber-900 flex items-start gap-2">
          ...
          <div>
            <strong>Regra RF07:</strong> Ao confirmar o check-in, a reserva
            passará para o status <strong>Ativa</strong> e o quarto será
            atualizado para <strong>Ocupado</strong>.
          </div>
        </div>
