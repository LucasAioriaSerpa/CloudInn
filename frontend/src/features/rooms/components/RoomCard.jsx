/**
 * @fileoverview Card visual de quarto com ações rápidas de governança e Motion (RF06, RF10, RF11)
 */
...
export function RoomCard({ room, onUpdateStatus, onQuickAction }) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="h-full p-4 flex flex-col justify-between hover:border-[#14248A]/50 transition-colors group">
        <div>
